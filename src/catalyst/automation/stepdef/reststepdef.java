...
import com.catalyst.qa.utils.*;
//import com.catalyst.qa.utils.Utils;
...
public class reststepdef extends RestUtil {
	...
	@Given("User hit the get employees (.*)")
	public void getEmployees(String WebServiceURL){
		response = getAll(WebServiceURL);
		System.out.println("response: " + response.body().asString());
      	}
	
	@Given("User hit the create employee (.*)")
	public void createEmployee(String WebServiceURL) {
		String[] data = {"id","1"};
		response = create(WebServiceURL,data);
		System.out.println("response: " + response.body().asString());
	}
